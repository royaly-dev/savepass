                        ...
                        {Manual && (
                            <>
                                ...
                                <View className='relative flex justify-center items-center w-full'>
                                    <Input secureTextEntry value={totpcode.key} onChange={(e) => { setTotpcode({ ...totpcode, key: e.nativeEvent.text }) }} id="password" placeholder="password" />
                                </View>
