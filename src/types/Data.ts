...
export type syncDevice = { syncKey: string, data: { syncKey: string, lastSync: number, name: string, public?: string }[], lastSync: number, status: boolean, private: string, public: string }
